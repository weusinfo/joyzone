...
public final class SensitiveWordUtils {
    ...
    private static class SensitiveWordHolder{
    	private static final SensitiveWordUtils INSTANCE = new SensitiveWordUtils();
    }
...
//                + "难过就躺在某一个人的怀里尽情的阐述心扉或者手机卡复制器一个人一杯红酒一部电影在夜三级片 深人静的晚上，关上电话静静的发呆着,裙中性运动";
//        System.out.println("被检测字符长度:"+str.length());
//        str = SensitiveWordUtils.getInstance().filterInfo(str);
